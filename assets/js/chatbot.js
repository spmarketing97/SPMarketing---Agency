...
function setupSmoothScroll() {
    ...
    const bannerCTA = document.getElementById('scroll-to-services');
    if (bannerCTA && !bannerCTA._hasScrollListener) {
        ...
        // Marcar que ya tiene un listener para evitar duplicados
        bannerCTA._hasScrollListener = true;
    }

    // Manejar otros enlaces de navegación suave
    document.querySelectorAll('a[href^="#"]:not(#scroll-to-services)').forEach(anchor => {
